#-------------------------------------------------------------------------
# AUTHOR: Joshua Gomez
# FILENAME: CNN or Convoluted Neural Network
# SPECIFICATION: This program takes as input several images of numbers, and a Convoluted Neural Network will be generated to read in the images
#                from the files for "train" and "test" data. The model will learn a pattern to recognize and categorize their labels with an
#                accuracy and loss measure
...
# digit_dataset instead of images
